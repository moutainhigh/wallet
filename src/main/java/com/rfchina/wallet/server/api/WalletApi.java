...
public interface WalletApi {
	 ...
	 * @return
	 */
	WalletChannel seniorWalletChannelInfo(String accessToken, Byte source, Integer channelType, Long walletId);
	 ...
	 * @return
	 */
	YunstApplyBindBankCardResult seniorWalletVerifyBankCard(String accessToken, Long walletId, Byte source,
	 ...
	 * @return
	 */
	Long seniorWalletConfirmBindBankCard(String accessToken, Long walletId, Byte source, String transNum,
