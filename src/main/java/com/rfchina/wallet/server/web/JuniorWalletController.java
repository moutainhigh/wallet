...
public class JuniorWalletController {
	...
	public ResponseValue<PayRespBody> slPay(
		@ApiParam(value = "电子凭证号(业务方定义唯一)", required = true) @RequestParam("elec_cheque_no") String elecChequeNo,
		@ApiParam(value = "收款人账号", required = true, example = "95200078801300000003") @RequestParam("payee_acct_no") String payeeAcctNo,
		@ApiParam(value = "收款人名称", required = true, example = "浦发2000040752") @RequestParam("payee_name") String payeeName,
