...
public class YunstImplTest extends SpringApiTest {
	...
	public void changeBindPhone() throws Exception {
		String bizUserId = "TestU1568186437709";
		Integer type = bizUserId.startsWith("CTest") ? 1 : 2;
		Tuple<Boolean, String> tuple = yunstApi.modifyPhone(accessToken, bizUserId, type, "18928847212", "13800138000",
				"11111");
		logStack(tuple);
	}
	...
	public void getMemberInfo() throws Exception {
		String bizUserId = "TestU1568186437709";
		Integer type = bizUserId.startsWith("CTest") ? 1 : 2;
		YunstMemberInfoResp memberInfo = yunstApi.getMemberInfo(accessToken, bizUserId, type);
		logStack(memberInfo);
	}
